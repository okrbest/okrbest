...
// okrbest: upstream split these types into properties_user as part of the property
// system v2 lineage we did not adopt; our tree still exports them from properties,
// which is also what custom_profile_attributes/helpers.ts imports.
