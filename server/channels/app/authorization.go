...
//
// Upstream also resolves ChannelTypeOpenBoard here; okrbest has no board channel types
// (see docs/upstream-inert-features.md), so only ChannelTypeOpen takes the team-membership path.
