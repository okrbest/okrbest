        ...
        let learnMore = (
            <div>
                <FormattedMessage
                    ...
                    defaultMessage='Join the OKR.BEST community at '
                />
                <ExternalLink
    ...
    if (config.BuildEnterpriseReady === 'true') {
        ...
        if (license.IsLicensed === 'true') {
            ...
            learnMore = (
                <div>
                    <FormattedMessage
                        id='about.enterpriseEditionLearnUnlicensed'
            ...
            <Modal.Body>
                ...
                <div className='about-modal__footer'>
                    ...
                    <div className='form-group'>
                        <div className='about-modal__copyright'>
                            <FormattedMessage
                                id='about.copyright'
                                defaultMessage='Copyright 2015 - {currentYear} OKR.BEST, Inc. All rights reserved'
                                values={{
                ...
                <div className='about-modal__notice form-group pt-3'>
                    <p>
                        <FormattedMessage
                            id='about.notice'
                            defaultMessage='OKR.BEST is made possible by the open source software used in our <linkServer>server</linkServer>, <linkDesktop>desktop</linkDesktop> and <linkMobile>mobile</linkMobile> apps.'
                            values={{
