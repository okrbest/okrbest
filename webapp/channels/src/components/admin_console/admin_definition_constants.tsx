    ...
    <tr>
        ...
        <td>
            <FormattedMessage
                ...
                defaultMessage='OKR.BEST will connect over an insecure connection.'
            />
        </td>
    </tr>
);
    ...
    <tr>
        ...
        <td>
            <FormattedMessage
                ...
                defaultMessage='Encrypts the communication between OKR.BEST and your server.'
            />
        </td>
    </tr>
);
                ...
                <tr>
                    ...
                    <td>
                        <FormattedMessage
                            ...
                            defaultMessage='The OKR.BEST server will serve static files compressed with gzip.'
                        />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <FormattedMessage
                            ...
                            defaultMessage='The OKR.BEST server will serve static files uncompressed.'
                        />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <FormattedMessage
                            ...
                            defaultMessage='The OKR.BEST server will not serve static files.'
                        />
                    </td>
                </tr>
            </tbody>
