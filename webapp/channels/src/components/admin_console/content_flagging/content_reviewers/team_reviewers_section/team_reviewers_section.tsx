            ...
            cells: {
                ...
                enabled: (
                    <Toggle
                        ...
                        ariaLabel={intl.formatMessage({id: 'admin.contentFlagging.reviewerSettings.toggle', defaultMessage: 'Enable or disable content reviewers for team {teamName}'}, {teamName: team.display_name})}
                        size='btn-md'
