...
export class DynamicVirtualizedList extends PureComponent<DynamicVirtualizedListProps, State> {
    ...
    private _initScrollWasCentered = false;
    private _initScrollCenteredIndex = -1;
    ...
    _getCenteredItemViewportCenter = (): number | null => {
        ...
        const measuredNodes = this._outerRef.getElementsByClassName('item_measurer') as HTMLCollectionOf<HTMLElement>;
