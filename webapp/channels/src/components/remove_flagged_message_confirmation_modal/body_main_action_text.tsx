        ...
        body = formatMessage(
            {
                ...
                defaultMessage:
                    'You are about to remove a message authored by {flaggedPostAuthor} posted in the {flaggedPostChannel} channel and flagged for review by {reportingUser}.',
            },
            values,
        );
    } else {
        body = formatMessage(
            {
                ...
                defaultMessage:
                    'You are about to keep a flagged message authored by {flaggedPostAuthor} posted in the {flaggedPostChannel} channel and flagged for review by {reportingUser}.',
            },
            values,
        );
    }
