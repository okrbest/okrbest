...
export function FormStepFooter({
    ...
    const continueText = formatMessage({id: 'keep_remove_flag_content_modal.continue.button_text', defaultMessage: 'Continue'});
    const removeText = formatMessage({id: 'keep_remove_flag_content_modal.action_remove.button_text', defaultMessage: 'Remove message'});
    const keepText = formatMessage({id: 'keep_remove_flag_content_modal.action_keep.button_text', defaultMessage: 'Keep message'});
        ...
        <div className='ModalFooterRow'>
            <div className='ModalFooterRow__left'>
                ...
                >
                    ...
                    <span>
                        <FormattedMessage
                            id='keep_remove_flag_content_modal.download_report_checkbox.label'
                            defaultMessage='Download flagged message report'
                        />
                    </span>
                </label>
            </div>
