    ...
    return (
        <>
            ...
            <ReportNotice
                ...
                title={
                    <FormattedMessage
                        id='keep_remove_flag_content_modal.generated.title'
                ...
                body={
                    action === 'remove' ? (
                        <FormattedMessage
                            id='keep_remove_flag_content_modal.action_remove.generated.body'
                        ...
                        <FormattedMessage
                            id='keep_remove_flag_content_modal.action_keep.generated.body'
