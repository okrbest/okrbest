    ...
    return (
        <>
            ...
            <ReportNotice
                ...
                title={
                    <FormattedMessage
                        id='keep_remove_flag_content_modal.generating.title'
                ...
                body={
                    action === 'remove' ? (
                        <FormattedMessage
                            id='keep_remove_flag_content_modal.action_remove.generating.body'
                        ...
                        <FormattedMessage
                            id='keep_remove_flag_content_modal.action_keep.generating.body'
