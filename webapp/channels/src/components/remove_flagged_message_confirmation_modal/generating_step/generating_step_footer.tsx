...
export function GeneratingStepFooter({action, onSkip, onBack}: FooterProps) {
    ...
    const skipText = formatMessage({id: 'keep_remove_flag_content_modal.skip_report_download.button_text', defaultMessage: 'Skip report download'});
    const backText = formatMessage({id: 'keep_remove_flag_content_modal.back.button_text', defaultMessage: 'Back'});
    const removePermanentlyText = formatMessage({id: 'keep_remove_flag_content_modal.action_remove.permanent_button_text', defaultMessage: 'Remove permanently'});
    const keepPermanentlyText = formatMessage({id: 'keep_remove_flag_content_modal.action_keep.permanent_button_text', defaultMessage: 'Keep permanently'});
