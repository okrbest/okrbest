...
export default function KeepRemoveFlaggedMessageConfirmationModal({action, onExited, flaggedPost, reportingUser}: Props) {
    ...
    const removeLabel = formatMessage({id: 'keep_remove_flag_content_modal.action_remove.title', defaultMessage: 'Remove message from channel'});
    const keepLabel = formatMessage({id: 'keep_remove_flag_content_modal.action_keep.title', defaultMessage: 'Keep message'});

    const removeWithoutReportLabel = formatMessage({id: 'keep_remove_flag_content_modal.action_remove_without_report.title', defaultMessage: 'Remove without report?'});
