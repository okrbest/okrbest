...
import {getIsRhsExpanded, getMentionFilter, getRhsState} from 'selectors/rhs';
...
export default function RhsSearchPopout() {
    ...
    const mentionFilter = useSelector(getMentionFilter);
    ...
    const handleMentionFilterChange = useCallback((filter: Parameters<typeof showMentions>[0]) => {
        dispatch(showMentions(filter));
    }, [dispatch]);
    ...
    return (
        <SearchResults
            ...
            onMentionFilterChange={handleMentionFilterChange}
        />
    );
}
