...
export default function OkrBestLogo(props: React.HTMLAttributes<HTMLSpanElement>) {
    ...
    return (
        <span {...props}>
            <svg
                ...
                role='img'
                aria-label={formatMessage({id: 'generic_icons.okrbest', defaultMessage: 'OKR.BEST Logo'})}
            >
                <g>
                    <g>
                        <path
