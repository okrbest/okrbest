...
export const ActionTypes = keyMirror({
    ...
    UPDATE_RHS_MENTION_FILTER: null,
...
export const AboutLinks = {
    TERMS_OF_SERVICE: 'https://okr.best/pl/terms-of-use/',
    PRIVACY_POLICY: 'https://okr.best/pl/privacy-policy/',
};
...
export const CloudLinks = {
    ...
    SELF_HOSTED_SIGNUP: 'https://customers.okr.best/signup',
    DELINQUENCY_DOCS: 'https://docs.okrbest.com/about/cloud-subscriptions.html#failed-or-late-payments',
    SELF_HOSTED_PRICING: 'https://okr.best/pl/pricing/#self-hosted',
};

export const HostedCustomerLinks = {
    BILLING_DOCS: 'https://okr.best/pl/how-self-hosted-billing-works',
    SELF_HOSTED_BILLING: 'https://okr.best/pl/self-hosted-billing',
    TERMS_AND_CONDITIONS: 'https://okr.best/enterprise-edition-terms/',
    SECURITY_UPDATES: 'https://okr.best/security-updates/',
    DOWNLOAD: 'https://okr.best/download',
    NEWSLETTER_UNSUBSCRIBE_LINK: 'https://forms.okr.best/UnsubscribePage.html',
    PRIVACY: AboutLinks.PRIVACY_POLICY,
};

export const DocLinks = {
    ABOUT_TEAMS: 'https://docs.okrbest.com/welcome/about-teams.html#team-url',
    ADVANCED_LOGGING: 'https://okr.best/pl/advanced-logging',
    CONFIGURE_DOCUMENT_CONTENT_SEARCH: 'https://okr.best/pl/configure-document-content-search',
    CONFIGURE_AD_LDAP_QUERY_TIMEOUT: 'https://okr.best/pl/configure-ad-ldap-query-timeout',
    CONFIGURE_OVERRIDE_SAML_BIND_DATA_WITH_LDAP: 'https://okr.best/pl/configure-override-saml-bind-data-with-ldap',
    COMPILANCE_EXPORT: 'https://okr.best/pl/compliance-export',
    COMPILANCE_MONITORING: 'https://okr.best/pl/compliance-monitoring',
    DATA_RETENTION_POLICY: 'https://okr.best/pl/data-retention-policy',
    ...
    GUEST_ACCOUNTS: 'https://docs.okrbest.com/onboard/guest-accounts.html',
    HIGH_AVAILABILITY_CLUSTER: 'https://okr.best/pl/high-availability-cluster',
    IN_PRODUCT_NOTICES: 'https://okr.best/pl/in-product-notices',
    MULTI_FACTOR_AUTH: 'https://okr.best/pl/multi-factor-authentication',
    ONBOARD_ADVANCED_PERMISSIONS: 'https://okr.best/pl/advanced-permissions',
    ONBOARD_LDAP: 'https://okr.best/pl/setup-ldap',
    SELF_HOSTED_BILLING: HostedCustomerLinks.SELF_HOSTED_BILLING,
    SESSION_LENGTHS: 'https://okr.best/pl/configure-session-lengths',
    SETUP_IMAGE_PROXY: 'https://okr.best/pl/setup-image-proxy',
    SETUP_LDAP: 'https://okr.best/pl/setup-ldap',
    SETUP_PERFORMANCE_MONITORING: 'https://okr.best/pl/setup-performance-monitoring',
    SETUP_PUSH_NOTIFICATIONS: 'https://okr.best/pl/setup-push-notifications',
    SETUP_SAML: 'https://docs.okrbest.com/pl/setup-saml',
    SHARE_LINKS_TO_MESSAGES: 'https://okr.best/pl/share-links-to-messages',
    SITE_URL: 'https://okr.best/pl/configure-site-url',
...
export const DeveloperLinks = {
    CUSTOM_SLASH_COMMANDS: 'https://okr.best/pl/custom-slash-commands',
    ENABLE_OAUTH2: 'https://okr.best/pl/enable-oauth',
    INCOMING_WEBHOOKS: 'https://okr.best/pl/incoming-webhooks',
    OUTGOING_WEBHOOKS: 'https://okr.best/pl/outgoing-webhooks',
    INTERACTIVE_MESSAGES: 'https://okr.best/pl/interactive-messages',
    INTERACTIVE_DIALOGS: 'https://okr.best/pl/interactive-dialogs',
    PERSONAL_ACCESS_TOKENS: 'https://okr.best/pl/personal-access-tokens',
    PLUGIN_SIGNING: 'https://okr.best/pl/sign-plugins',
    PLUGINS: 'https://okr.best/pl/plugins',
    SETUP_CUSTOM_SLASH_COMMANDS: 'https://okr.best/pl/setup-custom-slash-commands',
    SETUP_INCOMING_WEBHOOKS: 'https://okr.best/pl/setup-incoming-webhooks',
    SETUP_OAUTH2: 'https://okr.best/pl/setup-oauth-2.0',
    SETUP_OUTGOING_WEBHOOKS: 'https://okr.best/pl/setup-outgoing-webhooks',
};
